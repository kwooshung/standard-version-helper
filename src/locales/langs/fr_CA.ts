/**
 * 法语（加拿大）：fr_CA
 * @description 法语（加拿大）语言包
 * @author KwooShung，Google Translate
 * @createat 2023-11-03 20:10:14
 */
...
export default {
  ...
  loading: {
    ...
    upgradingVersion: 'Mise à niveau{0}: v{1} > v{2} ...'
  },
  version: {
    ...
    tips: {
      ...
      enterInitialVersion: 'Veuillez saisir votre numéro de version initiale, par défaut v{0}:',
