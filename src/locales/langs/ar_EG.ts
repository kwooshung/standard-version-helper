...
export default {
  ...
  loading: {
    ...
    upgradingVersion: 'الترقية v{0}: v{1}> v{2} ...'
  },
  version: {
    ...
    tips: {
      ...
      enterInitialVersion: 'الرجاء إدخال رقم الإصدار الأولي الخاص بك ، الافتراضي 0.0.1:',
  ...
  menus: {
    ...
    revertToPreviousVersion: {
      updatePackageJson: 'ما إذا كان رقم الإصدار في ملف package.json: v{0} يتم تحديثه كرقم الإصدار الذي تم إلغاؤه v{1}',
