...
export default {
  ...
  version: {
    ...
    patch: '補丁版本',
    tips: {
      firstTimePrompt: '由於您還沒有發布過版本，需要進行首次發布。',
      failedToIncrement: '無法增加版本號',
      invalidVersionField: 'package.json 中的版本欄位缺失或無效',
      enterInitialVersion: '請輸入您的初始版本號，預設 0.0.1：',
  ...
  menus: {
    ...
    revertToPreviousVersion: {
      updatePackageJson: '是否將 package.json 檔案中的版本號：v{0} 更新為撤銷後的版本號 v{1}',
      failedToRetrieve: '無法從先前的提交中檢索版本號，暫時沒有修改 package.json 檔案中的版本號。如有需要，請手動修改。'
    }
  }
};
